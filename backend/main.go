...
import (
	"github.com/Hitmepls/backend/controller"
	"github.com/Hitmepls/backend/entity"
	"github.com/Hitmepls/backend/middlewares"
...
func main() {
	...
	api := r.Group("")
	{
		...
		{ //****************Tenant
			...
			//Repair
			protected.GET("/rooms/:id", controller.GetRoomofRepair)
			...
			protected.GET("/EquipmentName/:id", controller.GetEquipmentName)
			...
			// protected.GET("/RoomEquipmentName/:id", controller.GetRoomEquipmentName)
